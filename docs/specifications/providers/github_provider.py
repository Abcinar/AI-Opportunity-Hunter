...
class GitHubProvider(BaseProvider):
    ...
    def _request(self, path: str, params: dict[str, str] | None = None) -> Any:
        ...
        try:
            ...
            if exc.code in (401, 403):
                # Distinguish pure auth failure from rate-limit 403
    ...
    def health_check(self) -> bool:
        ...
        try:
            ...
            return True
        except (GitHubAuthenticationError, GitHubRateLimitError, GitHubAPIError, TimeoutError, urllib.error.URLError, json.JSONDecodeError):
            return False
